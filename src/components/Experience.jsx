...
const experiences = [
    {
        ...
        location: 'Presencial / Maracaibo',
        logo: tandemlogo,      
        bullets: [
            'Implementación de un módulo para la gestión de Business Partner, permitiendo el registro estructurado de personas, empresas y consultores, así como la definición de los servicios ofrecidos y su asignación automática a consultores internos.',
            'Desarrollo de un módulo para la gestión de fases operativas, automatizando el flujo de prestación de servicios para clientes corporativos y particulares',
            'Desarrollo de lógica de negocio mediante custom handlers con Node.js, aplicando validaciones, reglas de negocio y transformación de datos.',
        ],
    ...
    },
    {
        ...
        logo: tandemlogo,     
        bullets: [
            'Implementación de un módulo para la gestión de potreros, integrando Google Maps API para: Dibujar y editar polígonos geoespaciales, Visualizar zonas y validar restricciones, Obtener coordenadas, áreas y métricas operativas en tiempo real, Sincronizar la capa visual con la lógica de negocio del backend',
            'Diseño e implementación de un módulo de importación masiva de datos desde archivos Excel, con: Mapeo dinámico de entidades y campos, Reducción significativa del tiempo de carga de miles de registros en PostgreSQL.',
            'Aplicación de reglas de negocio mediante custom handlers en Node.js, gestionando: Normalización y transformación de datos, Manejo de errores y flujo transaccional',
        ],
